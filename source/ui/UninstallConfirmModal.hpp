...
namespace romm::ui {
    ...
    class UninstallConfirmModal : public pu::ui::elm::Element {
    private:
        s32 x, y, w, h;
        std::weak_ptr<romm::navigation::NavigationManager> nav_mgr;
    public:
        UninstallConfirmModal(std::shared_ptr<romm::navigation::NavigationManager> nav) 
        ...
        PU_SMART_CTOR(UninstallConfirmModal)
    };
